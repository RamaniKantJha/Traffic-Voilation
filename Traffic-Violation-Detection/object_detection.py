    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite(r"C:\Users\HP\Desktop\Traffic-Violation-Detection\Detected Images\violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = r"C:\Users\HP\Desktop\Traffic-Violation-Detection\yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
